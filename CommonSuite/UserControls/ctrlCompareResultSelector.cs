...
{
    public partial class ctrlCompareResultSelector : DevExpress.XtraEditors.XtraUserControl
    {
        public delegate void NotifySelectFile(object sender, SelectFileEventArgs e);
        public event ctrlCompareResultSelector.NotifySelectFile onFileSelect;


        public ctrlCompareResultSelector()
        {
            InitializeComponent();
        }
