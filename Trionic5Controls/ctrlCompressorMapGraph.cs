...
{
    public partial class ctrlComptressorMapGraph : DevExpress.XtraEditors.XtraUserControl
    {
        public delegate void RefreshData(object sender, EventArgs e);
        public event ctrlComptressorMapGraph.RefreshData onRefreshData;
        ...
        public ctrlComptressorMapGraph()
        {
            InitializeComponent();
        }
        ...
        public void SetCompressorType(CompressorMap compressorMap)
        {
            ...
            DrawLineonImage(bmp);
            chartControl1.BackImage.Image = null;
            chartControl1.BackImage.Stretch = true;
            
            string tempImagePath = @"C:\currimage.bmp";
            ...
            chartControl1.BackImage.Image = bmp2;
        ...
        private void DrawLineonImage(Bitmap bmp)
        {
            ...
            //scalablePictureBox1.PictureBox.Width = oorpronkelijke grootte
            //scalablePictureBox1.PictureBox.Height = oorpronkelijke grootte
            ...
            try
            {
                ...
                for (int i = 0; i < 16; i++)
                {
                    ...
                    pnts[i].X = x_location;
                    pnts[i].Y = y_location;
                    //Console.WriteLine("x: " + x_location.ToString() + " y: " + y_location.ToString());
                    if (i > 0)
                    {
                        // draw line
                    ...
                    graphic.DrawString(rpm.ToString("D4"), this.Font, Brushes.Black, x_location, y_location);
