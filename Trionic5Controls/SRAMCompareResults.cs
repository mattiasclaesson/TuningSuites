    ...
    public partial class SRAMCompareResults : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void CastSelectEvent(int m_map_address, int m_map_length, string m_map_name)
        {
            ...
            if (onSRAMSymbolSelect != null)
            {
                ...
                onSRAMSymbolSelect(this, new SelectSRAMSymbolEventArgs(m_map_address, m_map_length, m_map_name, m_filename1, m_filename2, false, m_compareSymbolCollection, m_compareAddressLookupCollection));
            }
        }
        ...
        private void CastDifferenceEvent(int m_map_address, int m_map_length, string m_map_name)
        {
            ...
            {
                // haal eerst de data uit de tabel van de gridview
                onSRAMSymbolSelect(this, new SelectSRAMSymbolEventArgs(m_map_address, m_map_length, m_map_name, m_filename1, m_filename2, true, m_compareSymbolCollection, m_compareAddressLookupCollection));
            }
        }
