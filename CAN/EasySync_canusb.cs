...
class EASYSYNC
{
	...
	public struct CANMsg
	{
        ...
        public ulong data2;		// Data Bytes 0..7
	}
    ...
    public static extern int canusb_Flush(uint handle);

    [DllImport("USBCanPlusDllF.dll", EntryPoint = "canplus_Reset")]
    public static extern int canusb_Reset(uint handle);

    [DllImport("USBCanPlusDllF.dll", EntryPoint = "canplus_Listen")]
    public static extern int canusb_Listen(uint handle);
    ...
    [DllImport("USBCanPlusDllF.dll", EntryPoint = "canplus_getFirstAdapter")]
    public static extern int canusb_getFirstAdapter(char[] adapter, int size);
