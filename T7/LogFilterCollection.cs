...
namespace T7
{
    public class LogFilterCollection : SortableCollectionBase, ICustomTypeDescriptor
    {
        ...
        public LogFilterCollection()
        {
            ...
            base.SortObjectType = typeof(LogFilter);
        }
        ...
        #endregion
        [TypeConverter(typeof(LogFilterCollectionConverter))]
        public LogFilterCollection Symbols
        {
            get { return this; }
        }
        ...
        internal class LogFilterCollectionConverter : ExpandableObjectConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                if (destType == typeof(string) && value is LogFilterCollection)
                {
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                LogFilterCollectionPropertyDescriptor pd = new LogFilterCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
        ...
        #endregion
        public class LogFilterCollectionPropertyDescriptor : PropertyDescriptor
        {
            private LogFilterCollection collection = null;
            private int index = -1;
            ...
            public override string DisplayName
            {
                get
                {
                    LogFilter emp = this.collection[index];
