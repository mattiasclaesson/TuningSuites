...
//                e.Graphics.DrawPolygon(p, pnts);
        ...
        {
            string imagename = "T8SuitePro.Compressormaps.t25_55_saab.gif";
            switch (compressorMap)
            {
                case CompressorMap.GT17:
                    imagename = "T8SuitePro.Compressormaps.GT17.jpg";
                    toolStripComboBox1.SelectedIndex = 0;
                    break;
                case CompressorMap.T25_55:
                    imagename = "T8SuitePro.Compressormaps.t25_55_saab.gif";
                    toolStripComboBox1.SelectedIndex = 1;
                    break;
                case CompressorMap.T25_60:
                    imagename = "T8SuitePro.Compressormaps.t25-60trim.gif";
                    toolStripComboBox1.SelectedIndex = 2;
                    break;
                case CompressorMap.TD04:
                    imagename = "T8SuitePro.Compressormaps.td04-15g-cfm.gif";
                    toolStripComboBox1.SelectedIndex = 3;
                    break;
                case CompressorMap.TD0416T:
                    imagename = "T8SuitePro.Compressormaps.td04h-16t-cfm.gif";
                    toolStripComboBox1.SelectedIndex = 4;
                    break;
                case CompressorMap.TD0418T:
                    imagename = "T8SuitePro.Compressormaps.td04h-18t-cfm.gif";
                    toolStripComboBox1.SelectedIndex = 5;
                    break;
                case CompressorMap.TD0419T:
                    imagename = "T8SuitePro.Compressormaps.td04h-19t-cfm.gif";
                    toolStripComboBox1.SelectedIndex = 6;
                    break;
                case CompressorMap.TD0620G:
                    imagename = "T8SuitePro.Compressormaps.td06h-20g-cfm.gif";
                    toolStripComboBox1.SelectedIndex = 7;
                    break;
                case CompressorMap.GT2871R:
                    imagename = "T8SuitePro.Compressormaps.gt2871r-48.jpg";
                    toolStripComboBox1.SelectedIndex = 8;
                    break;
                case CompressorMap.GT28RS:
                    imagename = "T8SuitePro.Compressormaps.gt28rscompress.gif";
                    toolStripComboBox1.SelectedIndex = 9;
                    break;
                case CompressorMap.GT3071R86:
                    imagename = "T8SuitePro.Compressormaps.GT3071R86.jpg";
                    toolStripComboBox1.SelectedIndex = 10;
                    break;
                case CompressorMap.GT30R:
                    imagename = "T8SuitePro.Compressormaps.gt30rcompress.gif";
                    toolStripComboBox1.SelectedIndex = 11;
                    break;
                case CompressorMap.GT40R:
                    imagename = "T8SuitePro.Compressormaps.gt40rcompress.gif";
                    toolStripComboBox1.SelectedIndex = 12;
                    break;
                case CompressorMap.HX40W:
                    toolStripComboBox1.SelectedIndex = 13;
                    imagename = "T8SuitePro.Compressormaps.hx40w.jpg";
                    break;
            }
