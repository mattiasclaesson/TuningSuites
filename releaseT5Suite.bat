call SetupT5SuiteII\version.bat
devenv T5SuiteII.sln /Rebuild Release /project SetupT5SuiteII

pushd SetupT5SuiteII\Release\
"C:\md5sum.exe" T5SuiteII.msi >> T5SuiteII.md5
popd

mkdir z:\T5Suite2\%T5SuiteII.version%
xcopy SetupT5SuiteII\version.bat z:\T5Suite2\%T5SuiteII.version%\
xcopy SetupT5SuiteII\Release\T5SuiteII.msi z:\T5Suite2\%T5SuiteII.version%\
xcopy SetupT5SuiteII\Release\T5SuiteII.md5 z:\T5Suite2\%T5SuiteII.version%\
