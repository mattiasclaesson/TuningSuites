...
namespace T7
{
    ...
    class T7FileHeader
    {
        ...
        public bool IsTISBinary(string a_filename)
        {
            bool retval = true;
            ...
            do
            {
                ...
                fhf = readField(fs);
                if (fhf.m_fieldID == 0x92 || fhf.m_fieldID == 0x90) retval = false;
            }
            while (fhf.m_fieldID != 0xFF);    // Don't write past 0xF9 "End of header"
            fs.Close();
            return retval;
        }
        ...
        public bool save(string a_filename)
        {
            ...
            try
            {
                ...
                while (fhf.m_fieldID != 0xFF /* && fhf.m_fieldID != 0xF9 */ && fhf.m_fieldID != 0x00);    // Don't write past 0xF9 "End of header"
                fs.Close();
            }
            catch (Exception E)
            {
        ...
        public bool init(string a_filename, bool AutoFixFooter)
        {
            ...
            do
            {
                ...
                switch (fhf.m_fieldID)
                {
                    ...
                    case 0x9B: // symboltable address
                        ...
                        break;
                    case 0x9C: // unknown (OFFSET FOR SRAM 2 FLASH CONVERSION) <GS-28092010>
            ...
            while (fhf.m_fieldID != 0xFF && fhf.m_fieldID != 0x00 /*&& fhf.m_fieldID != 0xF9 */);    // Don't read past 0xF9 "End of header"
            fs.Close();
        ...
        internal string getSIDDate()
        {
            return m_testserialnr;
        }

        public void setSIDDate(string a_string)
        {
            m_testserialnr = a_string;
        }
