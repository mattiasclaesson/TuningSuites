...
namespace T7
{
    abstract public class IMapViewer : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public abstract int StandardFill
        {
            get;
            set;
        }

        public abstract int AutoUpdateInterval
        {
            get;
            set;
        }
        ...
        public abstract bool IsOpenSoftware
        {
            get;
            set;
        }
        ...
        */
        ...
        abstract public void HighlightCell(int tpsindex, int rpmindex);
        ...
        abstract public event MapViewerEx.NotifyReadSymbol onSymbolRead;
