...
{
    public class RealtimeSymbolCollection : SortableCollectionBase, ICustomTypeDescriptor
    {
        #region CollectionBase implementation

        public RealtimeSymbolCollection()
        {
            //In your collection class constructor add this line.
            //set the SortObjectType for sorting.
            base.SortObjectType = typeof(RealtimeSymbolHelper);
        }

        public RealtimeSymbolHelper this[int index]
        {
            get
            {
                return ((RealtimeSymbolHelper)List[index]);
            }
            set
            {
                List[index] = value;
        ...
        #endregion
        [TypeConverter(typeof(RealtimeSymbolCollectionConverter))]
        public RealtimeSymbolCollection Symbols
        {
            get { return this; }
        }
        ...
        internal class RealtimeSymbolCollectionConverter : ExpandableObjectConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                if (destType == typeof(string) && value is RealtimeSymbolCollection)
                {
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                RealtimeSymbolCollectionPropertyDescriptor pd = new RealtimeSymbolCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
        ...
        #endregion
        public class RealtimeSymbolCollectionPropertyDescriptor : PropertyDescriptor
        {
            private RealtimeSymbolCollection collection = null;
            private int index = -1;

            public RealtimeSymbolCollectionPropertyDescriptor(RealtimeSymbolCollection coll, int idx)
                :
            ...
            public override string DisplayName
            {
                get
                {
                    RealtimeSymbolHelper emp = this.collection[index];
