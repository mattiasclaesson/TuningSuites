...
namespace RealtimeGraph
{
	...
	/// </summary>
	public sealed class RealtimeGenericComparer:IRealtimeGenericComparer 
	{
		#region RealtimeGenericComparer
		/// <summary>
		/// Sorting order
		/// </summary>
	...
	/// <summary>
	/// IRealtimeGenericComparer - Generic interface for object comparison
	/// </summary>
	public interface IRealtimeGenericComparer : IComparer
	{
		Type ObjectType
		{
			get;set;
	...
	public interface ISortable
	{
		...
		RealtimeGenericComparer.SortOrder SortingOrder
		{
			get;set;
		}
		Type SortObjectType
	...
	public abstract class SortableCollectionBase : CollectionBase,ISortable
	{
		...
		RealtimeGenericComparer.SortOrder sortingOrder = RealtimeGenericComparer.SortOrder.Ascending;
		public RealtimeGenericComparer.SortOrder SortingOrder
		{
			get{return sortingOrder;}set{sortingOrder = value;}
		}
		...
		public virtual void Sort() 
		{
			...
			IRealtimeGenericComparer sorter = new RealtimeGenericComparer();
