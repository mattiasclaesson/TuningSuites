...
namespace Plot3D
{
    ...
    public static class FunctionCompiler
    {
        ...
        public static CompiledFunction Compile(int parametersCount, string functionBody)
        {
            ...
            {
                //throw new FunctionNotCompiledException(T8SuitePro.Properties.Resources.FunctionCompiler_SemicolonException);
            }
            ...
            //string str = string.Format(T8SuitePro.Properties.Resources.FunctionCompiler_EvalClass, strb.ToString(), typeof(CompiledFunction).Namespace);
