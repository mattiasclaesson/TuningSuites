...
//            this.AddToCanTrace("Flasher error");
    ...
    */
    ...
    {
        Console.WriteLine("LPCCANDevice_T7::readFlash");
        base.readFlash(a_fileName);
        Console.WriteLine("LPCCANDevice_T7::readFlash2");

        try
        {
            // connect to ECU; this may take some time as both
            // P-Bus and I-bus are checked for traffic
            Console.WriteLine("LPCCANDevice_T7::readFlash3");
            if (!this.beginSession())
            {
                Console.WriteLine("LPCCANDevice_T7::readFlash4");

                throw new Exception("Failed to start session");
            }
            Console.WriteLine("LPCCANDevice_T7::readFlash5");
