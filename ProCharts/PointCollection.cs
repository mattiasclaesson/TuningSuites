...
namespace ProCharts
{
    public class PointCollection : SortableCollectionBase, ICustomTypeDescriptor
    {
        ...
        public PointCollection()
        {
            ...
            base.SortObjectType = typeof(PointHelper);
        }

        public PointHelper this[int index]
        {
            get
            {
                return ((PointHelper)List[index]);
            }
            set
            {
                List[index] = value;
        ...
        public PointCollection Symbols
        {
            get { return this; }
        }
        ...
        internal class PointCollectionConverter : ExpandableObjectConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                if (destType == typeof(string) && value is PointCollection)
                {
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                PointCollectionPropertyDescriptor pd = new PointCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
        ...
        #endregion
        public class PointCollectionPropertyDescriptor : PropertyDescriptor
        {
            private PointCollection collection = null;
            private int index = -1;

            public PointCollectionPropertyDescriptor(PointCollection coll, int idx)
                :
            ...
            public override string DisplayName
            {
                get
                {
                    PointHelper emp = this.collection[index];
                    return (string)(emp.Pointvalue.ToString());
                }
            }
            ...
            public override string Description
            {
                get
                {
                    ...
                    sb.Append(emp.Pointvalue.ToString());
                    sb.Append(", ");
