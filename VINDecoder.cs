...
namespace T8SuitePro
{
    ...
    public class VINDecoder
    {
        ...
        private string DecodeTransmissionType(string VINNumber)
        {
            ...
            else if (VINNumber[6] == '6') return "6-speed manual";
...
9 = Trollhättan Line C 
        ...
        {
            //YS3FD49YX71133697 =  B207R 4-inline, Turbo, PETROL, TURBO (B207 R)
            if (VINNumber.Length < 8) return VINEngineType.Unknown;
//            else if (VINNumber[7] == 'A') return VINEngineType.B206I; // B235L
