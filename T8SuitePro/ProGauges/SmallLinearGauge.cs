...
namespace ProGauges
{
    public partial class SmallLinearGauge : UserControl, ISupportInitialize
    {
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Toggles ranges display on/off"), DefaultValue(typeof(bool), "true")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Toggles value display on/off"), DefaultValue(typeof(bool), "true")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Toggles value display from actual values to percentage"), DefaultValue(typeof(bool), "false")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Sets the text for the gauge"), DefaultValue(typeof(bool), "Linear gauge")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Sets the units for the gauge"), DefaultValue(typeof(bool), "units")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge background color"), DefaultValue(typeof(Color), "System.Drawing.Color.Black")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge bevel color"), DefaultValue(typeof(Color), "System.Drawing.Color.Gray")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge value"), DefaultValue(typeof(float), "0")]
        public float Value
        {
            get { return m_value; }
            set
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge recommended value"), DefaultValue(typeof(float), "25")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge recommended percentage"), DefaultValue(typeof(int), "10")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge threshold value"), DefaultValue(typeof(float), "90")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge maximum scale value"), DefaultValue(typeof(float), "100")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge minimum scale value"), DefaultValue(typeof(float), "0")]
        ...
        public SmallLinearGauge()
        {
            ...
            try
            {
                ...
                {
                    this.Font = fn = new Font(ff, 10, FontStyle.Bold);
                }
            }
            catch (Exception E)
            {
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Switches highlighting of the gauge on and off"), DefaultValue(typeof(bool), "true")]
        ...
        [DefaultValue(50), Browsable(true), Category("SmallLinearGauge"), Description("Set the opaque value of the highlight")]
        ...
        [DefaultValue(100), Browsable(true), Category("SmallLinearGauge"), Description("Set the opaque start value of the highlight")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge recommended range color"), DefaultValue(typeof(Color), "System.Drawing.Color.LawnGreen")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge recommended range color"), DefaultValue(typeof(Color), "System.Drawing.Color.Firebrick")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge start color"), DefaultValue(typeof(Color), "System.Drawing.Color.GreenYellow")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge end color"), DefaultValue(typeof(Color), "System.Drawing.Color.OrangeRed")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge alpha value for the gauge colored bar"), DefaultValue(typeof(int), "180")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Sets number of divisions that should be drawn"), DefaultValue(typeof(int), "5")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge tick color"), DefaultValue(typeof(Color), "System.Drawing.Color.Gray")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Sets number of sub divisions that should be drawn"), DefaultValue(typeof(int), "4")]
        ...
        [Browsable(true), Category("SmallLinearGauge"), Description("Set the gauge text color"), DefaultValue(typeof(Color), "System.Drawing.Color.Silver")]
        ...
        private void DrawBackground(Graphics g)
        {
            ...
            //SolidBrush bt = new SolidBrush(Color.Transparent);
            DrawRoundRect(g, this.ClientRectangle, 3, m_BackGroundColor, Color.Gray, Color.Green, 1, true, true);
        ...
        private void GetCenterRectangle()
        {
            ...
            rcentre = new Rectangle(this.ClientRectangle.X , this.ClientRectangle.Y , (this.ClientRectangle.Width ), (this.ClientRectangle.Height ));
        }
