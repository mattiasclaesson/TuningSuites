...
namespace T5CANLib.CAN
{
    ...
    /// </summary>
    abstract public class ICANDevice
    {
        /// <summary>
        ...
        abstract public void clearTransmitBuffer();

        abstract public void clearReceiveBuffer();

        abstract public void EnableLogging(string path2log);
        abstract public void DisableLogging();
        ...
        abstract public int GetNumberOfAdapters();

        abstract public void setPortNumber(string portnumber);
        /// <summary>
