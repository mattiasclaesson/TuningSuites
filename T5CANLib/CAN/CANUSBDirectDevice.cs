...
namespace T5CANLib.CAN
{
    ...
    /// </summary>
    public class CANUSBDirectDevice : ICANDevice, IDisposable
    {
        ...
        private string m_startuppath = @"C:\Program files\Dilemma\T5SuiteII";
        private int m_baudrate = 115200 * 4; // test
                ...
                while (!endofFrames)
                {
                    ...
                    else
                    {
                        ...
                        if (line.Length == 14)
                        {
                            ...
                            if (m_DoLogging)
                            {
                                DumpCanMsg(r_canMsg, false, true);
                            }
