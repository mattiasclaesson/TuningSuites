...
class LAWICEL
{
    ...
    [DllImport("canusbdrv.dll", EntryPoint = "canusb_Flush")]
    public static extern int canusb_Flush(uint handle, byte flags);
    ...
    [DllImport("canusbdrv.dll", EntryPoint = "canusb_getFirstAdapter")]
    public static extern int canusb_getFirstAdapter(char[] szAdapter, int size);
