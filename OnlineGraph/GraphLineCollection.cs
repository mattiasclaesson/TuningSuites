...
namespace OnlineGraph
{
    public class GraphLineCollection : SortableCollectionBase, ICustomTypeDescriptor
    {
        ...
        #endregion
        [TypeConverter(typeof(GraphLineCollectionConverter))]
        public GraphLineCollection Symbols
        {
            get { return this; }
        }
        ...
        internal class GraphLineCollectionConverter : ExpandableObjectConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                if (destType == typeof(string) && value is GraphLineCollection)
                {
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                GraphLineCollectionPropertyDescriptor pd = new GraphLineCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
        ...
        #endregion
        public class GraphLineCollectionPropertyDescriptor : PropertyDescriptor
        {
            private GraphLineCollection collection = null;
            private int index = -1;
            ...
            public override string DisplayName
            {
                get
                {
                    GraphLine emp = this.collection[index];
            ...
            public override string Description
            {
                get
                {
                    ...
                    sb.Append(", ");
                    sb.Append(emp.Numberofmeasurements.ToString());
                    return sb.ToString();
                }
            }
