...
namespace T7
{
    public class MNemonicCollection : SortableCollectionBase, ICustomTypeDescriptor
    {
        #region CollectionBase implementation

        public MNemonicCollection()
        {
            //In your collection class constructor add this line.
            //set the SortObjectType for sorting.
            base.SortObjectType = typeof(MNemonicHelper);
        }

        public MNemonicHelper this[int index]
        {
            get
            {
                return ((MNemonicHelper)List[index]);
            }
            set
            {
                List[index] = value;
        ...
        #endregion
        [TypeConverter(typeof(MNemonicCollectionConverter))]
        public MNemonicCollection Symbols
        {
            get { return this; }
        }
        ...
        internal class MNemonicCollectionConverter : ExpandableObjectConverter
        {
            public override object ConvertTo(ITypeDescriptorContext context, System.Globalization.CultureInfo culture, object value, Type destType)
            {
                if (destType == typeof(string) && value is MNemonicCollection)
                {
                    // Return department and department role separated by comma.
                    return "MNemonicHelper";
                }
                return base.ConvertTo(context, culture, value, destType);
            }
        }
        ...
        public PropertyDescriptorCollection GetProperties()
        {
            ...
            for (int i = 0; i < this.List.Count; i++)
            {
                ...
                MNemonicCollectionPropertyDescriptor pd = new MNemonicCollectionPropertyDescriptor(this, i);
                pds.Add(pd);
            }
        ...
        #endregion
        public class MNemonicCollectionPropertyDescriptor : PropertyDescriptor
        {
            private MNemonicCollection collection = null;
            private int index = -1;
            ...
            public override string DisplayName
            {
                get
                {
                    MNemonicHelper emp = this.collection[index];
                    return (string)(emp.Mnemonic.ToString());
                }
            }
            ...
            public override string Description
            {
                get
                {
                    ...
                    sb.Append(emp.Mnemonic);
                    sb.Append(", ");
                    sb.Append(emp.Address.ToString("X8"));
                    return sb.ToString();
                }
            }
